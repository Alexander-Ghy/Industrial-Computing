/**
 ...
 The pinref_t type (pin reference type) can be used to refer to any pin,
 connected to an even or odd port, configured as output.
 The buttonpinref_t type (button pin reference type) can be used to refer to any pin,
 connected to an even or odd port, configured as input.
*/
#ifndef COMMON_H
#define COMMON_H
...
*/
struct output_ref_s {
   uint8_t mask;    /**< Bitmask of the associated pin. Result of BIT(pin), pin in the range [0,7]    */
...
*/
typedef struct input_ref_s input_pinref_t;
